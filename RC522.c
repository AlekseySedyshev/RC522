...
//==============SPI CMD============================
static inline void 		SPI1_WriteReg(uint8_t address, uint8_t value) {
 uint8_t temp;
CS_LO();

while (!(SPI1->SR & SPI_SR_TXE)){};  
SPI1_DR_8bit = address;
...
static inline uint8_t SPI1_ReadReg(uint8_t address) {
  uint8_t reg_val;
CS_LO();
while (!(SPI1->SR & SPI_SR_TXE)){}; 
SPI1_DR_8bit = address;
